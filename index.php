 ...
 <div class="header_top">
    <div class="wrap">
	  <div class="header-top-left">
			<div class="logo">
			     <a href="index.html"><h1>bibliothèque</h1>
			     	<h2>bienvenue </h2>
			     </a>
			</div>
		<div class="menu">
		     <ul class="menu bounce">
		       ...
		       <li><a href="single.html">les CD</a></li>
...
<div class="wrap">
	<div class="main">
		<div class="content">
			<div class="box1">
   				 <h3><a href="single.html">bienvenue sur notre bibliothèque</a></h3>
    				<span>donner votre comments<span class="comments">8 Comments</span></span> 
			   <div class="view">
					<div class="view-back">
					...
					<a href="single.html"><img src="http://static.eyrolles.com/img/2/2/1/2/5/6/8/9/9782212568936_h130.png"></a>
				</div>
				<div class="data">
				    <p>Le livre est défini par Littré comme une « réunion de plusieurs feuilles servant de support à un texte manuscrit ou imprimé ». Dans son Nouveau Dictionnaire universel (édition de 1870), Maurice Lachâtre le définit comme un « assemblage de plusieurs feuilles de papier, de vélin, de parchemin, imprimées ou écrites à la main cousues ensemble et formant un volume recouvert d'une feuille de papier, de carton, de parchemin, de basane, de veau, de maroquin, etc. ».</p>
				    <span><a href="single.html">Continue reading >>></a></span>
				</div>
			<div class="clear"></div>
		</div>
			<div class="box1">
			   	 <h3><a href="single.html">choisie les livres</a></h3>
			    <span>donner votre comments<span class="comments">5 Comments</span></span>
			 <div class="view">
					<div class="view-back">
						<span class="views" title="views">(566)</span>
						<span class="likes" title="likes">(124)</span>
			...
			<div class="clear"></div>
				...
				<div class="box1">
				 ...
				 <div class="view">
					...
					<div class="data"> Un CD (abréviation de « Compact Disc » en anglais1), ou disque compact, est un disque optique utilisé pour stocker des données sous forme numérique.

Le Compact Disc a été développé par Sony et Philips et lancé en 1982.</p>
					    <span><a href="single.html">Continue reading >>></a></span>
					</div> 
				<div class="clear"></div>
			</div>
	 ...
	 <ul>
		...
		<li><a href="#"><span class="category-name">Fashion</span> <span class="count">(15)</span><div class="clear"></div></a></li>
			...
			<div class="popular-post">
				<h3>popular-posts</h3>
					<div class="post-grid">
						<img src="images/1.jpg" title="post1" alt=""/>
